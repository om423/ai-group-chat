...
import { z } from 'zod';
import { facilitatorAgent } from '../agents';
...
const callAgent = createStep({
  id: 'callAgent',
  description: 'Invoke the facilitator agent with the user prompt using streamVNext',
  ...
  execute: async ({ inputData }) => {
     ...
     */
    const streamResult = await facilitatorAgent.streamVNext(messages, {
